...
class CreateMatrix3JarakIdealTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('matrix_3_jarak_ideal', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('matrix_3_jarak_ideal');
    }
}
